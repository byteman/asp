...
/*整车式消息号*/
	...
	Msg_BackAlex_Come,		//后轴识别器进轴
	Msg_BackAlex_Add,		//后轴识别器进轴
	Msg_BackAlex_Remove,	//后轴识别器进轴
	Msg_At_Turn,			//前车离开后计时到
	Msg_Cmd_Repeat,			//重新采集
...
//升级接收数据分段内存池
#define NetUpdateDataLen	6
#define NetUpdateDataSize 264		//升级数据包长度256
