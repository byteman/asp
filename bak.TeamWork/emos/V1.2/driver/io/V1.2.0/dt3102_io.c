...
void DT3102_DeviceSignal_DefaultInit(void)
{
...
void Assign_3102_DeviceSignal(uint16 val)
{
	DT3102Signal.value = val;
}

u16 Obtain_3102_DeviceSignal(void)
{
