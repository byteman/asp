...
static SYS_STK *pStack_JobUSBBottom = NULL;
...
static s8 USB1JOB_Open(u32 lParam)
{
	...
	pStack_JobUSBBottom = (SYS_STK *)Ccm_Malloc(JOB_USB1_STACK_SIZE * sizeof(SYS_STK));
    pStack_JobUSBBottom += (JOB_USB1_STACK_SIZE - 1);
