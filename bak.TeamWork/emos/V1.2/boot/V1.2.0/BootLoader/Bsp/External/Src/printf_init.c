...
/****************************************************************************
* 名	称：void Set_PrintfPort(const u8 Port)
* 功	能：设置打印输出端口
* 入口参数：const u8	打印显示端口号 串口1 = 1	串口2 = 2 .....
* 出口参数：无
* 说	明：无
****************************************************************************/
...
/****************************************************************************
* 名	称：int fputc(const int ch, FILE *f)
...
/****************************************************************************
* 名	称：u8 SendToPrintf(u8* ShowChar,const u32 Len)
* 功	能：将需要打印输出的数据通过信号量发送至打印输出线程
* 入口参数：u8* ShowChar	需要打印的字符
						const u32 Len			字符长度
