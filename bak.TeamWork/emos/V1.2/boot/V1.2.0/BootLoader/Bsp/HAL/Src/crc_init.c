...
****************************************************************************/
u32 CRC32H_Chack8(const u8 flagC,u8 *pBuf, const u32 nSize)		  //取CRC32效验值
{
	u32 index = 0;
...
static u32 CRCSVAL = 0;		//软件CRC32值
static u32 CRC32S_Tab[] = 	//软件CRC32计算码
{ 
...
static u8 nCRCHi = 0;		//CRC16计算用值
static u8 nCRCLo = 0;		//CRC16计算用值
...
* 功	能：CRC16效验
* 入口参数onst 簎8 flag		是否复位CRC16值		0不复位	1复位
			u8 *pData	多数据计算校验值
...
/****************************************************************************
* 名	称：void PushCrc16Byte(const u8 nData)
* 功	能：CRC16效验
* 入口参数：const u8 nData	单数据计算校验值
* 出口参数：无
