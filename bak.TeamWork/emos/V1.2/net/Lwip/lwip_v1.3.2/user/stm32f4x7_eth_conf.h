...
#ifdef USE_Delay
  //#include "bsp.h"                /* Header file where the Delay function prototype is exported */  
...
/* PHY Reset delay */ 
#define PHY_RESET_DELAY    ((uint32_t)0x000FFFFF)/10 
/* PHY Configuration delay */ 
#define PHY_CONFIG_DELAY   ((uint32_t)0x00FFFFFF)/10
