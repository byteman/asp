...
#ifndef ETH_RXBUFNB
 #define ETH_RXBUFNB             3     /*  5 Rx buffers of size ETH_RX_BUF_SIZE */
#endif
...
#ifndef ETH_TXBUFNB
 #define ETH_TXBUFNB             3      /* 5  Tx buffers of size ETH_TX_BUF_SIZE */
#endif
...
#define PHY_READ_TOMS                     ((uint32_t)5)
#define PHY_WRITE_TOMS                    ((uint32_t)5)
/**
  * @}
  */
