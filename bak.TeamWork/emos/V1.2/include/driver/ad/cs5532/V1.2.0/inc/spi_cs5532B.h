...
#ifndef __SPI_CS5532B_H
#define __SPI_CS5532B_H
...
#define CS5532B1    0x04
#define CS5532B2    0x08
...
int32 CS5532Bx_GetValue(void);	//为提高执行效率，该函数需要和	 CS5532B1_Flag或者CS5532B2_Flag函数配合使用
