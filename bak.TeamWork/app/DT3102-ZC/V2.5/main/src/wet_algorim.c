...
/*                                                                            */
/* Kaiser Constant = 9.000                                                    */
/*                                                                            */
/******************************************************************************/
//static float const znumF800L10[125] = 
//{
//        -5.128e-06,-9.263e-06,-1.482e-05,-2.2e-05,-3.1e-05,-4.193e-05,-5.489e-05,-6.985e-05,-8.67e-05,-1.052e-04,
//        -1.249e-04,-1.453e-04,-1.655e-04,-1.845e-04,-2.011e-04,-2.136e-04,-2.204e-04,-2.192e-04,-2.076e-04,-1.83e-04,
//        -1.424e-04,-8.252e-05,0.0,1.088e-04,2.477e-04,4.205e-04,6.311e-04,8.833e-04,1.181e-03,1.527e-03,
//        1.926e-03,2.379e-03,2.89e-03,3.459e-03,4.089e-03,4.78e-03,5.532e-03,6.343e-03,7.212e-03,8.135e-03,
//        9.11e-03,1.013e-02,1.119e-02,1.229e-02,1.341e-02,1.455e-02,1.57e-02,1.685e-02,1.8e-02,1.912e-02,
//        2.022e-02,2.127e-02,2.228e-02,2.322e-02,2.409e-02,2.489e-02,2.56e-02,2.621e-02,2.672e-02,2.712e-02,
//        2.741e-02,2.759e-02,2.765e-02,2.759e-02,2.741e-02,2.712e-02,2.672e-02,2.621e-02,2.56e-02,2.489e-02,
//        2.409e-02,2.322e-02,2.228e-02,2.127e-02,2.022e-02,1.912e-02,1.8e-02,1.685e-02,1.57e-02,1.455e-02,
//        1.341e-02,1.229e-02,1.119e-02,1.013e-02,9.11e-03,8.135e-03,7.212e-03,6.343e-03,5.532e-03,4.78e-03,
//        4.089e-03,3.459e-03,2.89e-03,2.379e-03,1.926e-03,1.527e-03,1.181e-03,8.833e-04,6.311e-04,4.205e-04,
//        2.477e-04,1.088e-04,0.0,-8.252e-05,-1.424e-04,-1.83e-04,-2.076e-04,-2.192e-04,-2.204e-04,-2.136e-04,
//        -2.011e-04,-1.845e-04,-1.655e-04,-1.453e-04,-1.249e-04,-1.052e-04,-8.67e-05,-6.985e-05,-5.489e-05,-4.193e-05,
//        -3.1e-05,-2.2e-05,-1.482e-05,-9.263e-06,-5.128e-06
//};
...
static float FastFirBuffPreAxle1[100]		= {0};
static float FastFirBuffPreAxle2[100]		= {0};
...
static char ScalerRegister(void)
{
	...
	//注册PreAxle1通道ADC初级滤波
	FirPreAxle1.bInit = 0;
	FirPreAxle1.nLen  = 100;
	FirPreAxle1.pDelay= FastFirBuffPreAxle1;
	FirPreAxle1.pZNum = znumF800L12;
	...
	//注册ADC初级滤波
	FirPreAxle2.bInit = 0;
	FirPreAxle2.nLen  = 100;
	FirPreAxle2.pDelay= FastFirBuffPreAxle2;
	FirPreAxle2.pZNum = znumF800L12;
	...
	switch(chanle) {
		...
		case PreAxle2Chanle:
			mStandValue = GetAdcChanleStandValue(hs_Main,ADChanle.preaxle1) 
										+ GetAdcChanleStandValue(hs_Main,ADChanle.preaxle2);
				
			if((mStandValue - gWetPar.PreAxle1ZeroAD - gWetPar.PreAxle2ZeroAD) != 0.000000f)
				tmpk = inWet / (mStandValue  - gWetPar.PreAxle1ZeroAD - gWetPar.PreAxle2ZeroAD);	
