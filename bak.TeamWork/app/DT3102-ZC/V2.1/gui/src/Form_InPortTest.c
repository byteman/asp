...
static char attritemstr[10][4];	//[20],一个汉字,只需要2个字节		
...
DEF_ATTR_CTRL(mInPortAttr, &gWD_InPortTest, 0, 20, 240, 108, "输入调试状态",(CAttrItem *)(_attritem), sizeof(_attritem)/sizeof(CAttrItem), 0, CTRL_VISABLE);
