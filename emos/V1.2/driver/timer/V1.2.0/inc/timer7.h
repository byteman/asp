#ifndef _TIM7_INIT_H_	
#define _TIM7_INIT_H_
...
#define TIM7_CMDClearCnt			0				//清空计数器
#define TIM7_CMDTimOpen				1				//开启定时器启用中断响应
#define TIM7_CMDTimClose			2				//关闭定时器关闭中断响应
#define TIM7_CMDSetCntFlag		3				//设置计数开关
#define TIM7_CMDSetCaller			4				//设置回调函数

typedef void(*TIM7_fun)(void); 			//函数指针
...
* 说	明：无
****************************************************************************/
u8 TIM7_Config(TIM7_fun Cfun,u16 TimeUS,u8 mode);	 	//定时器初始化
