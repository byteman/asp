...
#define TIM2_CMDClearCnt			0				//清空计数器
#define TIM2_CMDTimOpen			1				//开启定时器启用中断响应
#define TIM2_CMDTimClose			2				//关闭定时器关闭中断响应
#define TIM2_CMDSetCntFlag		3				//设置计数开关
#define TIM2_CMDSetCaller		4				//设置回调函数

typedef void(*TIM2_fun)(void); 			//函数指针
	
/****************************************************************************
* 名	称：u8 TIM2_Config(TIM2_fun Cfun,u16 TimeUS,u8 mode)
* 功	能：定时器配置
...
* 说	明：无
****************************************************************************/
u8 TIM2_Config(TIM2_fun Cfun,u16 TimeUS,u8 mode);	 	//定时器初始化
